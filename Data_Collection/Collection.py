...
Original file is located at
    https://colab.research.google.com/drive/1C3_gy3QOvNQ8PPfiE6Tg-EJbWqIZloXs
"""
...
def get_abstract_multiproc(proc_num, total_process, lock, lists, lists_author, lists_url, lists_title, _article_ids,
                           lists_failed,lists_aid):
...
# You need to insert an if _name_ == '_main_':
